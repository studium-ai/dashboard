...
colnames(persons) = c('ps_id', 'full_name', 'gender', 'birth_day', 'birth_month', 'birth_year', 'death_day', 'death_month', 'death_year', 'floruit_y1', 'floruit_y2', 'int_notes', 'ext_notes', 'birth_place_id', 'death_place_id', 'import', 'to_be_merged', 'merged_id')
...
colnames(ps_att_institutions) = c('ps_inst_id', 'institution_id', 'ps_att_id')
...
sources = all_files[['sources2.tab']]

colnames(sources) = c('source_id', 'title', 'format','type', 'd1', 'm1', 'y1', 'd2', 'm2', 'y2', 'place_id1', 'place_id2', 'import'  )

source_institutions = all_files[['source_institutions.tab']]

colnames(source_institutions) = c('source_inst_id', 'source_id', 'inst_attest', 'inst_id', 'inst_rol', 'import')
