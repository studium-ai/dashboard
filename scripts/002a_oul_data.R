...
oul_df = readxl::read_excel('studium_export/Scholars@OldLouvain-20250513-final.xlsx')

filename = 'Scholars@OldLouvain-20250224-final.xlsx'

wikidata_oul = readxl::read_excel('studium_export//Scholars@OldLouvain-20250214-final.xlsx')
